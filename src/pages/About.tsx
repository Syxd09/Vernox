  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="max-w-3xl mx-auto px-6 py-24 flex-1">
        <p className="text-xs uppercase tracking-[0.3em] text-gold mb-3">Our craft</p>
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>If you have a sketch, a photo, or just a vibe, our <Link to="/customize" className="text-gold underline underline-offset-4">Design Studio</Link> is the fastest way to bring it to life.</p>
        </div>
      </section>
      <SiteFooter />
    </div>
